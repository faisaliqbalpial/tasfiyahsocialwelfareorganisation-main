...
import { advisoryCommittee, adhocCommittee, volunteers, CommitteeMember } from "@/data/committeeData";
import { UserCheck, Heart, FileText } from "lucide-react";

const Committee = () => {
  const [searchParams] = useSearchParams();
  const type = searchParams.get("type") || "advisory";
